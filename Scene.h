...
private:
    // Write any other stuff here
		Vector3f diffuse(ReturnVal ret, Material* mat, Ray ray, PointLight* light);
		bool isDark(Vector3f point, PointLight* light);
		Vector3f specular(Ray ray, ReturnVal ret, Material* mat, PointLight* light);
		Vector3f ambient(Material* mat);
